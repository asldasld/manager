...
exports.run = async (client, message, args) => {
 ...
 if(!message.member.roles.cache.has('763798894672478218')) return message.channel.send('Bu kodu kullanmak için yeterli yetkin yok!')
  ...
  let ver = "763798894613495882"; ///verilecek rol idsi
  let ver2 = "763798894613495881"; ///verilecek rol idsi
  let ver3 = "770449885136814141"; ///verilecek rol idsi
...
setTimeout(function(){member.roles.add(ver3)},3000)
  ...
  const embed = new Discord.MessageEmbed()
    .setColor("RANDOM")
    .setDescription(`
${member.user} adlı kişi ${message.author} tarafından başarıyla <@&763798894613495882> rolü verilerek kayıt edildi. 
`)
